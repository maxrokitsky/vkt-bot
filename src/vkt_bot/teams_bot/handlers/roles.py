...
from vkt_bot.bot_framework.bot.types import CallbackQueryEvent, NewMessageEvent
from vkt_bot.bot_framework.db.session import async_session
from vkt_bot.bot_framework.filters import RegexpFilter
from vkt_bot.bot_framework.handlers import (
    BotButtonCommandHandler,
    CommandHandler,
    MessageHandler,
)
from vkt_bot.bot_framework.repository import NotFoundError
...
from vkt_bot.teams_bot.handlers.callback import CallbackData, DeleteRoleCallbackData
