...
ИИ-агент
/ai `вопрос` - спросить агента про роли, чаты, события и переписку
Можно и без команды - просто упомяните бота: `@бот о чём тут договорились?`
...
/subscribethreads - подписать бота на обсуждения текущего чата
/subscribethreads off - отписаться от обсуждений чата

/history - включена ли запись истории сообщений чата
/history off - выключить запись истории в этом чате
